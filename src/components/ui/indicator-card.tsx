...
export function IndicatorCard({ 
    ...
    return (
        <motion.div 
            ...
            className={cn(
                "group relative enterprise-card p-4 sm:p-6 md:p-8 transition-all duration-300",
        ...
        >
            ...
            <div className="space-y-1 md:space-y-1.5">
                ...
                {(subtext || trend) && (
                    <div className="flex items-center gap-1.5 md:gap-3 pt-2 md:pt-4 border-t border-border mt-2 md:mt-4">
                        {trend && (
                            <span className={cn(
